...
!function (t) {
    ...
    ;
    var _, E = "resize.webflow orientationchange.webflow load.webflow";
        ...
        window.tram = function (t) {
            ...
            var M = e.frame = function () {
                ...
                e.init = function (e) {
                    ...
                    R.backface && U.hideBackface && G(this.el, R.backface.css, "hidden")
                }
                    ,
                    b("add", r),
                    b("start", o),
                ...
                t.init = function (t, e, n, i) {
                    ...
                    K[o] && (o = K[o]),
                        ...
                        U.fallback || i.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                            this.string = this.name + L + this.duration + "ms" + ("ease" != this.ease ? L + d[this.ease][0] : "") + (this.delay ? L + this.delay + "ms" : ""))
                }
                    ,
                    t.set = function (t) {
            ...
            var G = t.style
                ...
                "max-height": [N, x],
                "line-height": [N, E],
                "scroll-top": [q, g, "scrollTop"],
                "scroll-left": [q, g, "scrollLeft"]
            }
                , Z = {};
            R.transform && (Y.transform = [W],
                Z = {
                    x: [x, "translateX"],
                    y: [x, "translateY"],
                    rotate: [_],
    ...
    , function (t, e, n) {
        ...
        i.define("edit", t.exports = function (t, e, n) {
                ...
                var r, o = t(window), a = t(document.documentElement), s = document.location, u = "hashchange",
                    c = n.load || function () {
                        r = !0,
    ...
    , function (t, e, n) {
        ...
        i.define("navbar", t.exports = function (t, e) {
                var n, a, s, u, c = {}, l = t.tram, d = t(window), f = t(document), h = e.debounce, p = i.env(),
                    v = '<div class="w-nav-overlay" data-wf-ignore />', m = ".w-nav", w = "w--open",
                    g = "w--nav-dropdown-open", b = "w--nav-dropdown-toggle-open", y = "w--nav-dropdown-list-open",
                    x = "w--nav-link-open", _ = r.triggers, E = t();
                ...
                function I(e) {
                    return function (n) {
                        ...
                        i.validClick(n.currentTarget) ? r && 0 === r.indexOf("#") && e.open && W(e) : n.preventDefault()
                    }
                }
